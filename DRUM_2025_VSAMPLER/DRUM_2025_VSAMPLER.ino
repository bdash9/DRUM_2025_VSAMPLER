...
// If your project (or a header) already defines ZBLACK, ZGREEN, etc.
// map the generic names used in the code to those.
...
// Colors that the compiler complains about but don’t have Z-prefixed suggestions:
// define them directly in RGB565 (standard Arduino_GFX format)

#ifndef DARKGREY
  #define DARKGREY 0x7BEF  // medium grey
#endif
...
#ifndef DARKGREEN
  #define DARKGREEN 0x03E0 // darker green
#endif
...
*/
//Continue booting if SD card is missing -Ben
